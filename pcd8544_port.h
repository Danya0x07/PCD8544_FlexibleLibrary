 ...
 * @{
 */
#define _ce_high()  /* ... something should be here */
#define _ce_low()   /* ... something should be here */
#define _dc_high()  /* ... something should be here */
#define _dc_low()   /* ... something should be here */
#define _rst_high() /* ... something should be here */
#define _rst_low()  /* ... something should be here */
/** @} */
...
#define _delay_ms(ms)   /* ... something should be here */
